        ...
        foreach ($row as $z) {
            ...
            if ($rows) {
                foreach ($rows as $x) {
                    ...
                    $body .= 'To RSVP, or for more details and messages about this event, visit your family\'s <a href="http://familink.codingerik.com">Familink</a> Events page. All replies to this email will go to the event organizer.<br><br>';
