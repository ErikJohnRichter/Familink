  ...
  <div data-page="features" class="page no-toolbar no-navbar">
    <div class="page-content">
     ...
     <div class="navbarpages">
       <div class="navbar_left"><a href="familink-secure.php"><img src="images/icons/blue/home.png" alt="" title="" /></a></div>
...
<div class="form-group" id="changeAdminCredentials">
    ...
    <table align="center" style="margin: 0 auto;">
        ...
        <tr> 
            ...
            <td>
                <input class="desktopInput2" id="changeAdminUsernameInput" type="text" name="new-admin-username" placeholder="New Username" style="font-size: 20px; width: 170px;" value="<?php echo $row['username']; ?>"/>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr> 
            ...
            <td>
                <input class="desktopInput2" id="changeAdminPasswordInput" type="password" name="new-admin-password" style="font-size: 20px; width: 170px;" placeholder="New Password" value=""/>
            </td>
        </tr>
    </table>
...
<div class="form-group" id="changeFamilyCredentials">
    ...
    <table align="center" style="margin: 0 auto;">
        ...
        <tr> 
            ...
            <td>
                <input class="desktopInput2" id="changeFamilyUsernameInput" type="text" name="new-family-username" style="font-size: 20px; width: 170px;" placeholder="New Username" value="<?php echo $rows['username']; ?>"/>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr> 
            ...
            <td>
                <input class="desktopInput2" id="changeFamilyPasswordInput" type="password" name="new-family-password" style="font-size: 20px; width: 170px;" placeholder="New Password" value=""/>
            </td>
            </tr>
            </table>
            <table style="margin: 0 auto;">
    ...
    <table align="center" style="margin: 0 auto;">
        <tr> 
            ...
            <td>
                ...
                <input class="desktopInput2" id="changeFamilyNameInput" type="text" name="new-family-name" style="font-size: 20px; width: 170px;" placeholder="New Family Name" value="<?php echo $row['family_name']; ?>"/>
            </td>
        </tr>
    </table>
    <table style="margin: 0 auto;">
