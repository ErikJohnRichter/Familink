...
function validateMemberForm() {
 ...
 function validateEventForm() {
      ...
      if (isValid == false) {
        alert("You are missing some items in your event.")
      }
      return isValid;
    }
...
function validateMessageForm() {
      ...
      if (isValid == false) {
        alert("You are missing some items in your message.")
      }
      return isValid;
    }
 ...
 function validateReplyForm() {
      ...
      if (isValid == false) {
        alert("You are missing some items in your reply.")
      }
      return isValid;
    }
